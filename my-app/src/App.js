    ...
    <>
      ...
      <Flex align="center" h="80px" bg="#0078ad" color="white">
        ...
        <Flex w="50%" align="center" h={"90%"} >
          ...
          <Box w="150px" display={"flex"} alignItems={"center"} justifyContent="center" h="70%" borderRadius={"20px"} marginLeft="4%"
            _hover={{ bg: "#141414" }}  >
        ...
        <Flex w="50%" align="center" h={"90%"}>
          ...
          <Box w="20%" h="50%" alignItems="center" justifyContent="center" display="flex" borderRadius="20px" marginLeft={"1%"}
            _hover={{ bg: "#141414" }}>
